...
const Members = ({ name, designation, image }) => {
  return (
    <div className="card">
      <div
      ...
      <div className="card-socials">
        <button className="card-socials-btn facebook hover:animate-bounce">
          <svg
            data-name="Layer 21"
            height="24"
            id="Layer_21"
        ...
        <button className="card-socials-btn github hover:animate-bounce">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="33"
            height="33"
        ...
        <button className="card-socials-btn linkedin hover:animate-bounce">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="512"
            viewBox="0 0 512 512"
